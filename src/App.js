        ...
        return (
            <div className="App">
                    ...
                    <div style={{ paddingBottom: '3em' }} className='container'>
                        <div id='kitch-a-dee' className='row'>
                            <div className='col col-sm-12 col-md-6'>
                                <a href='https://docs.google.com/viewer?url=https://github.com/ljandrea/ljandrea.github.io/blob/deployment/Final-Proto.pdf'
                                    target="_blank">
                                    <h5>Kitch-A-Dee</h5>
                                </a>
                ...
                <section id='contact' ref={(section) => { this.Contact = section; }}>
                    ...
                    <p>Let's connect!</p>
                    <a id='resume'
                        href='https://docs.google.com/viewer?url=https://github.com/ljandrea/ljandrea.github.io/blob/deployment/Resume.pdf'
                        target="_blank"
...
//         return (
//             <header id='landing'>
//                 <img id='logo' src='./alj.jpg' alt='alj logo' />
//                 <div id='intro'>
//                     <h1>hi, i'm andrea.</h1>
//                     <hr id='intro-div' />
//                     <h6>software supporter | data devotee</h6>
...
//                         // href='#bio'
//                         onClick={() => {
//                             scrollToComponent(this.Bio, this.props.scroll)
//                         }}
//                         className='btn btn-outline-dark'>who am I?</button>
//                 </div>
//             </header >
...
//                     <div id='kitch-a-dee' className='row'>
//                         <div className='col col-sm-12 col-md-6'>
//                             <a href='https://docs.google.com/viewer?url=https://github.com/ljandrea/ljandrea.github.io/raw/master/Final-Proto.pdf'
//                                 target="_blank">
//                                 <h5>Kitch-A-Dee</h5>
//                             </a>
//                             <h6 style={{ fontSize: '75%' }}>Jan 2017 - Mar 2017</h6>
...
//                 <p>Let's connect!</p>
//                 <a id='resume'
//                     href='https://docs.google.com/viewer?url=https://github.com/ljandrea/ljandrea.github.io/raw/master/Resume.pdf'
//                     target="_blank"
//                     style={{ marginBottom: '1em' }}
//                     className='btn btn-outline-info'>view my resume</a>
//                 <div id='external-links'>
